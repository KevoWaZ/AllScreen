...
export async function obtainCompanyMedias(
  ...
  const url = `https://api.themoviedb.org/3/discover/${type}?include_adult=false&include_video=false&language=fr-FR&page=${page}&sort_by=popularity.desc&with_companies=${id}`;
